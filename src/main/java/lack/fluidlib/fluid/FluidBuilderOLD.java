...
//
//    public FluidBuilderOLD(FlowableFluid fluidStill, FlowableFluid fluidFlowing, FluidProperties properties, TagKey<Fluid> fluidTagKey) {
//        this(fluidStill, fluidFlowing, properties, fluidTagKey, ModdedCauldronBlock::new);
//    }
//
//    public FluidBuilderOLD(FlowableFluid fluidStill, FlowableFluid fluidFlowing, FluidProperties properties,
...
//    }
//
//    public FlowableFluid getFluidStill() {
//        return fluidStill;
//    }
//
//    public FlowableFluid getFluidFlowing() {
//        return fluidFlowing;
//    }
//
...
//        return registerBucket(bucketId, settings1 -> new BucketItem(fluidStill, settings), settings);
//    }
//
